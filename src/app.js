...
galleryContainer.insertAdjacentHTML("afterbegin", createGalleryList);
...
function onGalleryContainerClick(evt) {
  ...
  let imageEl = evt.target;
  const originalImageSrc = imageEl.getAttribute("data-source");
  const originalImageAlt = imageEl.getAttribute("alt");

  // ======= Подмена значения атрибута src =======
  lightboxImg.setAttribute("src", originalImageSrc);
  lightboxImg.setAttribute("alt", originalImageAlt);
